import { MapPin, Clock, Users, Building2, ChevronRight, Star, TrendingDown } from 'lucide-react'
...
function CentreCard({ centre, onSelect, isRecommended }) {
  ...
  return (
    <div className={`bg-white rounded-2xl border shadow-sm card-hover overflow-hidden ${isRecommended ? 'border-green-400 ring-2 ring-green-100' : 'border-slate-100'}`}>
      {isRecommended && (
        <div className="bg-green-700 text-white px-4 py-2 flex items-center gap-2 text-sm font-semibold">
