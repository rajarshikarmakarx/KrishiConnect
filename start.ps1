...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd '$RootDir\backend'; `$env:PYTHONPATH='$RootDir\backend'; & '$VenvPython' -m uvicorn app.main:app --host 0.0.0.0 --port 8000 --reload"
